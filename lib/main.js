...
(function() {
  var BASE, CND, EXTENSION, LODASH, badge, rpr, warn;
  ...
  this._correct_formula_ordering = function(elements) {
    var element, idx, last_idx, sub_element, _ref;
    idx = -1;
    ...
    while (true) {
      ...
      if (this._naive_formula_matcher.test(element)) {
        _ref = [elements[idx + 1], elements[idx]], elements[idx] = _ref[0], elements[idx + 1] = _ref[1];
        if (CND.isa_list((sub_element = elements[idx]))) {
